...
inherit libtool python-any-r1 toolchain-funcs flag-o-matic
...
src_configure() {
	# bug #956287
	# similar fix is already in a PR: https://github.com/gentoo/gentoo/pull/43220
	# just hasn't been merged into main
